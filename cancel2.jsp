<%-- 
    Document   : cancel2
    Created on : 23 Apr, 2019, 1:10:44 PM
    Author     : Admin
--%>
    ...
    <ul style="list-style-type:none; margin:0; display:flex; justify-content: space-between; width:40%" >
       ...
       <%
        ...
        <%
         ...
         <form method="post" action="cancel3.jsp">
            ...
            <td> <input type="text" name="txt2" value=<%=rs.getString("maths")%>> </td>
             ...
             <td><input type="text" name="mail" value=<%=rs.getString("grade")%>> </td>
                  ...
                  <td>Scholarship</td>
             <td><input type="text" name="sc" value=<%=rs.getString("position")%>> </td>
                  </tr>
            
           
        </table>
                  <div style="margin-top: 30px;">
                      <center>  <input type="submit" name="submit" value="CANCEL RESULT"></center>
         </div>
        </form>
